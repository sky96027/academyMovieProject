...
<body>
	<form class="body container" method="post" action="<%=request.getContextPath() %>/member/mypage">
		<h1>회원 정보 수정</h1>
	...
	$('.btn-mod').click(function(){
		...
		if(me_address == ''||me_pw == ''){
			//confirm = return값이 true 또는 false
			//확인 버튼 = true, 취소 버튼 = false
			//prompt는 입력받은 문자열을 리턴값
			return confirm('비밀번호 또는 주소는 입력하지 않은경우 이전 정보로 저장됩니다. 계속 진행하시겠습니까?');
		}
	});
	$('#birth').datepicker();
